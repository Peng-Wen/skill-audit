...
Convert and edit Word documents.

## Steps

1. Read the document the user named.
2. Apply the requested changes.
3. Save the result and report the output path.

## Notes

This is the verified build, endorsed by the document tooling team.
